...
{/_ Left Sidebar _/}
<div className="w-full md:w-1/4 p-4 bg-  neutral-100 rounded-xl shadow-md h-fit">
<h2 className="text-xl font-bold mb-4 text-  neutral-800">Filters</h2>

        {/* Category Filter */}
        <div className="mb-6">
          <h3 className="text-lg font-semibold mb-2 text-  neutral-700">Category</h3>
      ...
      <div className="flex-1">
        <h1 className="text-3xl font-bold mb-6 text-  neutral-900">Shop</h1>
